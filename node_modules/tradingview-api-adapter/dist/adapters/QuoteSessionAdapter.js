...
class QuoteSessionAdapter extends events_1.EventEmitter {
    constructor($bridge, $isMultiChannel = false) {
        super();
        this.$bridge = $bridge;
    ...
    handleSessionListener(sessionData) {
        ...
        sessionData.params.forEach(param => {
            ...
            switch (param.s) {
                ...
                case 'permission_denied':
                    console.warn('Permission denied for', param.n, 'suggested alternative:', (_a = param.v) === null || _a === void 0 ? void 0 : _a.alternative);
                    // Emit the permission denied information with the suggested alternative
                    this.emit('permission_denied', {
                        symbol: param.n,
                        alternative: (_b = param.v) === null || _b === void 0 ? void 0 : _b.alternative,
        ...
        if (this.firstLoad && !!sessionData.uploaded)
